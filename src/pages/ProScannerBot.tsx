ensure in digit percentage analysis the number of tick are fetch 1000 initial then to continue import { useState, useRef, useCallback, useEffect, useMemo } from 'react';
